...
import { ThemeColors, User, AuditLogEntry, PontosGlobal, FolhaAceite } from "../types";
...
export function AdmPanel({
  ...
  const [tab, setTab] = useState<"colaboradores" | "adm" | "auditoria" | "feriados" | "arquivo_morto" | "armazenamento" | "guia_manutencao" | "aceites">("colaboradores");
    ...
    <div style={{ minHeight: "100vh", background: t.bg }}>
      ...
      <div style={{ background: t.surface, borderBottom: `1.5px solid ${t.border}`, padding: "0 28px" }}>
        ...
        <div style={{ display: "flex", gap: 2, overflowX: "auto", whiteSpace: "nowrap", flexWrap: "nowrap" }} className="no-scrollbar">
          {(["colaboradores", "adm", "auditoria", "feriados", "arquivo_morto", "armazenamento", "guia_manutencao", "aceites"] as const).map(key => (
            <button
              key={key}
              onClick={() => setTab(key)}
              style={{
      ...
      {/* Main Table view */}
      {tab !== "auditoria" && tab !== "feriados" && tab !== "arquivo_morto" && tab !== "armazenamento" && tab !== "guia_manutencao" && tab !== "aceites" && (
